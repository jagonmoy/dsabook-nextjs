      ...
      <div className="form_div">
        <form className="space-y-6" onSubmit={(e) => submitForm(e)}>
          ...
          <div>
            ...
            <div className="mt-2">
              <input id="username" name="username" type="text" autoComplete="username" required className="input_field" 
          ...
          <div>
            ...
            <div className="mt-2">
              <input id="password" name="password" type="password" autoComplete="current-password" required className="input_field" 
